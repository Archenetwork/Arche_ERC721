...
////-----------------------------------------------
    ...
    function trust_user(address tokenOwner) public onlyOwner returns (bool success) {
        
        trusted[tokenOwner]=0x01;
        
        return true;
    }
    function untrust_user(address tokenOwner) public onlyOwner returns (bool success) {
        
        trusted[tokenOwner]=0x00;
